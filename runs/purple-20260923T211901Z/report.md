...
- Run window start: 2026-09-23T21:13:44.765472+00:00
- Chains fired: **10/10** (score 1.0)
- Alerts fired: **47** (27 distinct rules)
- ATT&CK techniques hit: **16** (16 of them armed-technique hits; hit rate over armed techniques: 0.39)
- Coverage map: 102 armed / 130 total rules (lookback 168h)
...
| purple-20260918T163442Z | 10/10 | 1.0 | 102 | 0.381 |
| (this run) | 10/10 | 1.0 | 102 | 0.39 |
...
| T1070 | defense_evasion_cleanup | 1.0 | DC-2 (2.0) | WHERE, WHO | unmeasured | IC-2 |
